...
export interface ServerInstance { id: string; orgId: string; hostId: string; name: string; gameType: string; capabilities: string[]; installPath: string | null; startCommand: string | null; telnetHost: string | null; telnetPort: number | null; maintenanceMode?: boolean; rebootIfDown?: boolean; mapEmbedUrl?: string | null; createdAt: string; }
